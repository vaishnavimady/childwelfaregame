...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'childwelfarerightslogo.jpg')) {
		$tcpdf_header_logo = 'childwelfarerightslogo.jpg';
	}
...
if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'CHILD WELFARE RIGHTS');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "ONLINE GAME");
}
